...
<li class="{{ Request::is('admin/issues*') ? 'active' : '' }}">
    <a href="{!! route('issues') !!}"><i class="fa fa-triangle-exclamation"></i><span>{{ucfirst(config('settings.issue_label_plural'))}}</span></a>
</li>
